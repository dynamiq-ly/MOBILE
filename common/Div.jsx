...
const Div = ({ children, radii = 'sm', shadowColor = 'main', title, button, onClick, buttonBackground = 'tag', buttonShadowColor = 'main', filled = false }) => {
  return (
    <StyleDiv radii={radii} background={filled ? 'container' : 'view'} style={filled && { ...shadow(shadowColor) }}>
      {title && (
        <StyledDivHeader>
